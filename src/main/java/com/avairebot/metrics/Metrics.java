...
import com.avbot.commands.utility.GlobalLeaderboardCommand;
...
public class Metrics {
    ...
    public static final Counter jdaEvents = Counter.build()
        .name("av_jda_events_received_total")
    ...
    public static final Counter commandsRatelimited = Counter.build()
        .name("av_commands_ratelimited_total")
    ...
    public static final Counter commandsReceived = Counter.build()
        .name("av_commands_received_total")
    ...
    public static final Counter commandsExecuted = Counter.build()
        .name("av_commands_executed_total")
    ...
    public static final Histogram executionTime = Histogram.build() // commands execution time, excluding ratelimited ones
        .name("av_command_execution_duration_seconds")
    ...
    public static final Counter commandExceptions = Counter.build()
        .name("av_commands_exceptions_total")
    ...
    public static final Counter commandAttempts = Counter.build()
        .name("av_command_attempts_total")
    ...
    public static void setup(av av) {
        if (isSetup) {
        ...
        if (!av.getConfig().getBoolean("web-servlet.metrics",
            av.getConfig().getBoolean("metrics.enabled", true)
        )) {
        ...
        av.getServlet().registerGet("/metrics", new GetMetrics());
