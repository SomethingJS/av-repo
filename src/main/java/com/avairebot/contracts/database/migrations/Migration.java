...
package com.avbot.contracts.database.migrations;
...
public interface Migration extends Reflectional {
     ...
     * @see com.avbot.time.Carbon
     */
    String created_at();

    /**
     * Attempts to migrate the database, this is automatically executed from the
     * {@link com.avbot.database.migrate.Migrations#up() migrate up} method.
     *
     ...
     * {@link com.avbot.database.migrate.Migrations#down() down()} and
     * {@link com.avbot.database.migrate.Migrations#rollback(int) rollback(int)} method.
     *
     * @param schema the database schematic instance
     * @return the result of the schematic instance call
     * @throws SQLException if a database access error occurs,
